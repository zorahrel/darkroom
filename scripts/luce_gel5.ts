...
- LUCE PRINCIPALE: un beauty dish grande e morbido con una gelatina TEAL, verde-acqua chiaro (teal gel). E' una luce FORTE: fronte, dorso del naso e zigomi sono quasi bianchi, con un riflesso lucido. IL COLORE STA AL CENTRO DELLA LUCE, SUL VISO: fronte, naso, zigomi e la guancia illuminata prendono una dominante teal fredda ben visibile, che sulle zone quasi bianche si legge come un bianco ghiacciato verde-acqua. Il bordo del viso, i capelli e le spalle restano del colore del fondo.
...
- Da dietro c'e' solo un filo sottile di luce sul bordo dei capelli, chiaro e poco colorato.
  ...
  for (let g = 1; g <= giri; g++) {
    const job = enqueueJob(
      ...
      JSON.stringify({
        recipe: "luce-gel-5",
        materia: MATERIA,
        cambiato: "da v172 (direzione giusta, colore sparito) e v174/175 (blu sui bordi): gelatina teal verde-acqua come v170, sulle alte luci forti e al centro del viso, contorno poco colorato",
    ...
    console.log(`[gel5] job ${job.id}  giro ${g}`);
  }
});
